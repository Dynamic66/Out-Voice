...
function Invoke-Speach {
    ...
    #sometimes things cant be said if these charaters are in the input
...
function Show-GUI_psf {
    ...
    $timer1_Tick = {
        ...
        If (($new -ne $processed) -and ($null -ne $new)) {
            ...
            Invoke-Speach -say $new -rate $($tbRate.Value - 10) -volume $($tbVolume.Value * 10) -voice $($cVoice.Text)
